...
#
# Run from the Task-3 folder:
#   bash run_tests.sh
#   (or: ./run_tests.sh  after  chmod +x run_tests.sh)
#
# By default the runner builds with the student's Task3.c. To validate the
# test harness against the reference solution instead, change Task3.c to
# Task3sol.c in the gcc line below.
...
echo "Building main ..."
if ! gcc main.c Task3.c -o main; then
