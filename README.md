...
- You may **NOT** use any C standard library functions that were not mentioned in the tutorial unless you were specifically instructed to do so. (no malloc or memcpy etc etc)
...
- There will be some provided helper functions (in an external file) for Task (2 and 3?) to assist you. You can use those functions as you please, but you cannot modify them.
